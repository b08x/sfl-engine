  ...
  module LLM
    module Signatures
      ...
      class ClauseAnnotationSignature < DSPy::Signature
        ...
        output do
          const :mood, String, description: "Mood classification"
          ...
          const :speaker_attitude, String, description: <<~DESC
            Speaker attitude, e.g. neutral, positive, negative, skeptical, assertive
          DESC
          const :topical_theme, String, description: "Main starting point (Subject, fronted element, or Predicator)"
          const :textual_theme, T.nilable(String), description: <<~DESC
            Conjunctions/connectives at start (e.g. however, therefore, and)
          DESC
          const :interpersonal_theme, T.nilable(String), description: <<~DESC
            Modal adjuncts/discourse markers at start (e.g. surely, perhaps, well)
          DESC
          const :rheme, T.nilable(String), description: "Everything after the Theme"
          const :theme_type, T.nilable(String), description: "Theme type classification"
          ...
          const :inference_rule, String, description: <<~DESC
